...
This guide provides comprehensive documentation for the **scripting** skill in the custom-plugin-linux plugin.
...
```bash
# Invoke the skill
claude "scripting - [your task description]"

# Example
claude "scripting - analyze the current implementation"
```
...
def implement_scripting(input_data):
    """
