...
This guide provides comprehensive documentation for the **shell-basics** skill in the custom-plugin-linux plugin.
...
```bash
# Invoke the skill
claude "shell-basics - [your task description]"

# Example
claude "shell-basics - analyze the current implementation"
```
...
def implement_shell_basics(input_data):
    """
    Implement shell-basics functionality.
