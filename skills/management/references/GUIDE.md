...
This guide provides comprehensive documentation for the **management** skill in the custom-plugin-linux plugin.
...
```bash
# Invoke the skill
claude "management - [your task description]"

# Example
claude "management - analyze the current implementation"
```
...
def implement_management(input_data):
    """
